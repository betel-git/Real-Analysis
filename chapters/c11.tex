...
\begin{proof}
    ...
    Определим
    $\underline{g_n}(x) = \underline{f_n}(x) - \underline{f_1}(x)$, $x \in [a,b]$ — уже неотрицательная функция.
    ...
    где
    \[\underline{g}(x) = \lim\limits_{n\to \infty} \underline{f_n}(x) - \underline{f_1}(x),\]
