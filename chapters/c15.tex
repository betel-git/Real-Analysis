...
\begin{theorem}[Неравенство Гёльдера для интегралов]
    ...
    Тогда $f,g \in \widetilde{L}_1(E,\mu)$. Более того,
...
\begin{proof}\tab
    ...
    следовательно, ряд $\sum\limits_{k=0}^{\infty}y_k$ абсолютно сходится, но тогда ряд $\sum\limits_{k=0}^{\infty}y_k$ сходится в $E$, следовательно, существует $x \in E$, что
