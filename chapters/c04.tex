...
\begin{definition}
    Пусть $\mu_0: \mathcal{P} \to [0, + \infty]$ — счётно-аддитивная мера на полукольце $\mathcal{P}$ подмножеств множества $X$. Для любого $E \subset X$ определим его \textit{верхнюю меру по Каратеодори}:
