...
\begin{proof}
    ...
    \begin{equation}
        0 \leqslant h(x) \leqslant f(x) \leqslant g(x) \quad \forall x \in E. \label{eq:9.1}
    \end{equation}
...
\begin{proof}
    ...
    Если же $\theta g(x) > 0$, то по определению предела поскольку 
    \[\lim\limits_{n \to \infty} f_n(x) \geqslant g(x) > \theta g(x),\]
    то существует 
