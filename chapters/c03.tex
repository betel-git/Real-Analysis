...
\end{lemma}
\begin{proof}
    Действительно, если $\tau(A) = 0$, то в силу монотонности внешней меры $$\tau(E \cap A) = 0 \quad \forall E \subset X.$$
...
\begin{proof}\tab
    \begin{enumerate}
        \item Система $\mathfrak{M}_{\tau}$ симметрична, то есть для любого $A \in \mathfrak{M_{\tau}}$ верно $A^c \in \mathfrak{M}_{\tau}$:
        ...
        \begin{equation}
            \tau(E) \geqslant \tau(E \cap A) + \tau(E \setminus A) \quad \forall E \subset X. \label{eq:3.2}
        \end{equation}
        ...
        Отсюда по индукции легко видеть, что если $A_1, \dots, A_N$ — дизъюнктные $\tau$-измеримые множества, то для любого $E \subset X$
        \begin{equation}
