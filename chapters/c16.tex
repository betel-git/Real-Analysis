...
Пусть $(X, \mathfrak{M}, \mu)$ — пространство с полной $\sigma$-конечной мерой $\mu$, $E \in \mathfrak{M}$.
\begin{definition}
    Будем называть \textit{существенным супремумом} для измеримой функции $f$ на пространстве с мерой $(X, \mathfrak{M}, \mu)$, где $E \in \mathfrak{M}$, следующее:
    \[\esup\limits_{x \in E} |f(x)| = \inf\{L > 0 \ | \ \mu(|f| > L) = 0\}.\]
\end{definition} 

\begin{definition}
    Будем говорить, что $f: E \to \overline{\R}$ \textit{существенно ограничена}, если
    \[\esup\limits_{x \in E} |f(x)| < +\infty.\]
\end{definition} 

\begin{definition}
    Определим $L_\infty(E)$ как ЛНП классов эквивалентности существенно ограниченных на $E$ функций с нормой $\esup$, то есть
    \[\|f\|_\infty = \esup\limits_E |f|.\]
\end{definition} 

\begin{theorem}[Обобщение неравенства Гёльдера]
    Пусть $f\in L_\infty(E)$ и $g\in L_1(E)$. Тогда $fg\in L_1(E)$ и
    \[\|fg\|_1 \le \|f\|_\infty \|g\|_1.\]
\end{theorem}
\begin{proof}
    По определению существенного супремума существует множество $E'\subset E$ такое, что
    \[\mu(E')=0\]
    ...
    \[\int_E |f g| d\mu
    \leqslant
    \int_E \|f\|_\infty |g| d\mu
    =
    \|f\|_\infty \int_E |g| d\mu.\]
    Следовательно,
...
Отсюда
\[
\esup_{x\in E}|f(x)g(x)|
\leqslant
\|f\|_\infty\|g\|_\infty.
\]

\begin{theorem}[Обобщение неравенства Минковского]
    Пусть $f,g\in L_\infty(E)$. Тогда $f+g\in L_\infty(E)$ и
    \[
    \|f+g\|_\infty
    \leqslant
    \|f\|_\infty+\|g\|_\infty.
...
\end{theorem}
\begin{proof}
    По определению существенного супремума существуют множества $E_f,E_g\subset E$ такие, что
    \[\mu(E_f)=\mu(E_g)=0,\]
    причём при $x\notin E_f$
    \[|f(x)|\leqslant \|f\|_\infty,\]
    а при $x\notin E_g$
...
\begin{theorem}
Пространство $L_\infty(E)$ полно.
\end{theorem}
\begin{proof}
    Пусть $\{f_n\}_{n=1}^\infty$ — фундаментальная последовательность в $L_\infty(E)$. Это означает, что
    \[
    ...
    \[\|f_n-f\|_\infty\to 0,\ n\to\infty.\]

    Зафиксируем $k\in\mathbb N$. По фундаментальности существует $N_k\in\mathbb N$ такое, что для всех $n,m\geqslant N_k$
    \[\|f_n-f_m\|_\infty<\frac1k.\]
    Это значит, что для каждой пары $n,m\geqslant N_k$ существует множество $E_{n,m}^{(k)}\subset E$ меры ноль такое, что для всех $x\notin E_{n,m}^{(k)}$
    ...
    Покажем, что для каждого $x\in E\setminus G$ числовая последовательность $\{f_n(x)\}$ фундаментальна. Действительно, для любого $k\in\mathbb N$ и любых $n,m\geqslant N_k$ имеем
    \[|f_n(x)-f_m(x)|\leqslant \frac1k.\]
    Следовательно, $\{f_n(x)\}$ фундаментальна в $\mathbb R$. Значит, она сходится.

    Определим функцию $f$ следующим образом:
    \[f(x):=\lim_{n\to\infty} f_n(x),\ x\in E\setminus G.\]
    ...
    Теперь докажем, что $f\in L_\infty(E)$. Так как $\{f_n\}$ фундаментальна в $L_\infty$, существует $N\in\mathbb N$ такое, что для всех $n\geqslant N$
    \[\|f_n-f_N\|_\infty<1.\]
    ...
    Итак, любая фундаментальная последовательность в $L_\infty(E)$ сходится по норме $L_\infty$ к элементу из $L_\infty(E)$. Следовательно, пространство $L_\infty(E)$ полно.
\end{proof}